  ...
  const Footer = (
    <>
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, margin: '28px 0' }}>
        ...
        <span style={{ fontSize: 12, color: textSec, fontWeight: 500, whiteSpace: 'nowrap' }}>ou continue com</span>
        <div style={{ flex: 1, height: 1, background: divider }} />
      </div>
      ...
      <button type="button"
        style={{
          ...
          fontSize: 15, fontWeight: 600, color: textPri,
          cursor: 'pointer', minHeight: 52, fontFamily: 'Inter, sans-serif',
          transition: 'border-color 0.2s',
        }}
        onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.borderColor = '#FFC107'; }}
